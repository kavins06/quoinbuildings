...
const team = [
  {
    ...
    bio: "Kavin founded Quoin on a single conviction: that AI will become the intelligence layer inside operations, not a tool layered on top of them. His career traces a direct line to that thesis. He began as a civil engineer in India overseeing infrastructure projects, moved into real estate market research and commercial mortgage banking, then spent few years in AI research and building platforms for real estate operators. Kavin leads the engineering team at Quoin and sets strategic direction. He holds a Bachelors in Civil Engineering from PSG College of Technology, a Master's in Real Estate with a graduate certificate in Competitive Intelligence from Georgetown University, and has passed CFA Level II.",
  },
  {
    hidden: true,
