...
const team = [
  {
    ...
    bio: "Kavin founded Quoin on a single conviction: that AI will become the intelligence layer inside real estate operations, not a tool layered on top of them. His career traces a direct line to that thesis. He began as a civil engineer in India overseeing infrastructure projects, then moved into real estate market research, including at the National Association of Realtors where he pioneered the organization's research function and produced its first city-level market reports. He went on to equity research before joining Newpoint Real Estate Capital, where he worked on agency loan origination. He then spent years in financial markets & AI research, with a focus on spatial intelligence, and building platforms for real estate operators. At Georgetown, he studied how prepared real estate firms actually are to adopt AI, finding that the barrier is rarely the technology. That research informed how Quoin was built. Kavin leads the engineering team at Quoin and sets strategic direction. He holds a B.E. in Civil Engineering from PSG College of Technology, a Master's in Real Estate with a graduate certificate in Competitive Intelligence from Georgetown University, and has passed CFA Level II.",
  },
  {
    hidden: true,
