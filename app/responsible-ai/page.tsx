...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "How Quoin decides what AI to build and deploy, with human-in-the-loop expectations, data boundaries, and operating safeguards.",
  path: "/responsible-ai",
  keywords: ["responsible AI property management", "human in the loop AI", "real estate AI safeguards"],
})

export default function ResponsibleAIPage() {
  return (
    <>
      <PageStructuredData name="Responsible AI" path="/responsible-ai" />
